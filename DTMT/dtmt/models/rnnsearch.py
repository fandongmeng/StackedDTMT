...
import dtmt.interface as interface
import dtmt.layers as layers
...
def encoding_graph(features, mode, params):
    ...
    # encoder
    cell_fw0 = layers.rnn_cell.DL4MTGRULAUTransiLNCell(params.hidden_size, 1.0 - params.rnn_dropout)
    cell_fw1 = layers.rnn_cell.DL4MTGRULAUTransiLNCell(params.hidden_size, 1.0 - params.rnn_dropout)
    ...
    if params.use_variational_dropout:
        ...
        cell_bw0 = tf.nn.rnn_cell.DropoutWrapper(
            cell_bw0,
            input_keep_prob=1.0 - params.dropout,
            output_keep_prob=1.0 - params.dropout,
            state_keep_prob=1.0 - params.dropout,
    ...
    initial_state = layers.nn.linear(initial_state, cell_fw0.output_size, True,
